...
public class HairActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hair_activities);
        viewPager2 = findViewById(R.id.hair_viewPager);
        tabLayout = findViewById(R.id.hair_tabLayout);
        textView = findViewById(R.id.hair_textView_appbar);
